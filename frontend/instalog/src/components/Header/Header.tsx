...
const Header: React.FC<HeaderProps> = ({ onSearch, formatEventsAsCSV, onFiltersButtonClicked, onLiveButtonClicked }) => {
  ...
  return (
    <header className="bg-white search-input-container flex">
      ...
      />
      <button onClick={handleFiltersButtonClicked} className='header-button flex justify-evenly items-center'>
        <span className='pr-1'>
      ...
      <button onClick={handleFormatEventsAsCSV} className='header-button flex justify-evenly items-center'>
        <span className='pr-1'>
      ...
      <button onClick={handleLiveButtonClicked} className='header-button live-header-button flex justify-evenly items-center'>
        <span className='pr-1'>
        <div
            className="flex-shrink-0 h-3 w-3 rounded-full text-white flex items-center justify-center p-1" style={{ background: liveEnabled ? "#119e37" : "#8F485D" }} >
          </div>
        </span>
        <span>LIVE</span>
      </button>
